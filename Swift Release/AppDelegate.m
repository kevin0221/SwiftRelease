...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"registored"] == nil)
    {
        [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInt:1] forKey:@"registored"];
    ...
    else
    {
        ...
        if ([fromSettings isEqualToString:@"true"])
        {
            
            return YES;
        }
        else if (fromSettings == nil || [fromSettings isEqualToString:@"false"])
        {
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Swift_Release" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Swift_Release.sqlite"];
    NSError *error = nil;
...
- (UIInterfaceOrientationMask)application:(UIApplication *)application supportedInterfaceOrientationsForWindow:(UIWindow *)window
{
    ...
    {
        SignatureViewController *fullController = (SignatureViewController *) self.window.rootViewController.presentedViewController;
